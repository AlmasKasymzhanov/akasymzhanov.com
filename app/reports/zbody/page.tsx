      ...
      <div style={{ maxWidth: 920, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <Section id="sec-1" title="1. Executive Summary">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 }}>
            <MetricCard label="Выручка Год 1" value="₸117M" sub="~$234K" color={C.accent} />
            <MetricCard label="Загрузки приложения" value="25 000" sub="за 12 месяцев" color={C.green} />
          ...
          <div style={{ ...sCard, borderColor: C.green, borderWidth: 2 }}>
            ...
            <p style={sP}>
              Зарина Гусман (150K+ живых подписчиков, сеть BodyPro из 13 филиалов) запустила вирусный челлендж приседаний с массовым вовлечением. Модель <strong style={{ color: C.pink }}>Phygital (Physical + Digital)</strong>: физический товар = точка входа, приложение = retention + основная прибыль, комьюнити = organic growth engine.
            </p>
          </div>
          ...
          <DataTable
            ...
            rows={[
              ...
              ["Операционная прибыль (40%)", "₸47M (~$94K)"],
            ]}
            highlight={5}
          />
        ...
        <Section id="sec-2" title="2. Профиль основателя">
          <DataTable
            ...
            rows={[
              ...
              ["Бизнес", "Сеть студий BodyPro — 13 филиалов аппаратной косметологии"],
              ["Медийность", "Harper's Bazaar KZ, ELLE KZ, Esquire KZ"],
              ["Аудитория", "Женщины 25-45, КЗ и СНГ, мотивированы здоровьем"],
              ["Вирусный формат", "Челлендж приседаний — массовое участие"],
              ["Франшизная модель", "BodyPro работает по франшизе → опыт масштабирования"],
            ]}
          />
          ...
          <DataTable
            ...
            rows={[
              ["Подписчики", "~50K Instagram", "150K+ Instagram"],
          ...
          <div style={{ marginTop: 16 }}>
            <DataTable
              ...
              rows={[
                ...
                ["SOM (Год 1)", "150K аудитория Зарины → 25K загрузок → 2500 платящих", "₸117M (~$234K)"],
              ]}
            />
          </div>
        ...
        <Section id="sec-5" title="5. Бизнес-модель — Phygital-воронка">
          <div style={{ ...sCard, padding: "28px 24px" }}>
            ...
            <FunnelStep step={1} label="Instagram (150K)" detail="Бесплатный контент, Stories, Reels" color={C.pink} />
