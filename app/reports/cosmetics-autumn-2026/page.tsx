      ...
      <div className={styles.container}>
        ...
        <header className={styles.hero}>
          ...
          <p className={styles.deck}>
            Какие товары выбрать, сколько они могут стоить, на что жалуются
            покупатели и как подготовить запуск по неделям.
          </p>
          ...
          <div className={styles.scopeNote}>
            <strong>О чём этот отчёт.</strong> Рынок Казахстана и продажи на
            Kaspi.kz. Рассматриваем запуск с сентября по ноябрь 2026 года.
            Основной сценарий — выпуск продукции под собственной маркой.
            Продажа уже существующих брендов разобрана отдельно.
          </div>
        </header>
