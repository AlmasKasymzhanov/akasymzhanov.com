  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "'Inter', -apple-system, sans-serif" }}>
      ...
      <div style={{ maxWidth: 740, margin: "0 auto", padding: "40px 20px 80px" }}>
        ...
        {/* ══════════════════════════════════════ */}
        {/*  SECTION 7: Промты для анализа          */}
        {/* ══════════════════════════════════════ */}
        <div style={sSection}>
          <h2 style={sH2}>7. Готовые промты для анализа ниш</h2>
        ...
        {/* ══════════════════════════════════════ */}
        {/*  SECTION 8: Готовые отчёты              */}
        {/* ══════════════════════════════════════ */}
        <div style={sSection}>
          <h2 style={sH2}>8. Готовые аналитические отчёты</h2>
        ...
        {/* ══════════════════════════════════════ */}
        {/*  SECTION 9: Продвинутый уровень — MCP   */}
        {/* ══════════════════════════════════════ */}
        <div style={sSection}>
