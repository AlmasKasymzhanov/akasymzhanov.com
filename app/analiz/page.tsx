    ...
    <div className="font-mono text-[var(--color-text)]">
      <div className="max-w-[1400px] mx-auto border-x border-[var(--color-border)] min-h-screen flex flex-col">
        ...
        <article className="w-full max-w-[680px] mx-auto px-4 sm:px-6 py-10 sm:py-12 md:py-16 flex-1">
          ...
          <Callout title="Эти ниши растут прямо сейчас.">
            Рост идёт на последних окнах, а не в прошлом сезоне — заходить в них можно
            сегодня. Если по товару есть хороший местный поставщик, запуск делается
            быстро: <b>FBS</b> — отгрузка со своего склада по факту заказа, без закупки
            партии на склад Wildberries; <b>FBO</b> — если поставщик рядом и партию можно
            отправить в короткий срок. Ждать поставку из Китая для входа не обязательно.
          </Callout>
          ...
          {/* ── 10 ── */}
          <SectionHead n="10" label="Разбор" title="Что это за ниши" />
          ...
          {/* ── 12 ── */}
          <SectionHead n="12" label="Ограничения" title="Что проверить перед входом" />
          <MonoTable
