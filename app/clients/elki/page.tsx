...
function StatStrip() {
  const stats = [
    ...
    { k: "База для обзвона", v: "сбор идёт", d: "телефоны + приоритет A/B/C/D" },
  ];
  return (
    ...
    <div className="font-mono text-[var(--color-text)]">
      <div className="max-w-[1400px] mx-auto border-x border-[var(--color-border)] min-h-screen flex flex-col">
        ...
        <article className="w-full max-w-[680px] mx-auto px-6 py-12 md:py-16 flex-1">
          ...
          <p className="text-[14px] leading-relaxed mb-4">
            По всем целевым сегментам мы собираем продавцов напрямую с Kaspi: по каждому - прямой
          ...
          <MonoTable
            ...
            rows={[
              [<b key="a">A</b>, "уже продают НГ-товары, магазин 1 000+ заказов, хороший рейтинг, без своего бренда ёлок", "звонить первыми, август-сентябрь"],
              [<b key="b">B</b>, "сезонщики (лето/школа) с объёмом - зимой полка пустая", "второй круг: «зимний ассортимент»"],
