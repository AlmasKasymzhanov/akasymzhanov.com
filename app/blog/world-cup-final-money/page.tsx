...
const ARTICLE_TITLE = "Кто заработал на финале ЧМ-2026: киты, арбитражёры и мошенники";
const ARTICLE_DECK =
  ...
  return (
    ...
    >
      ...
      <section className="mb-12">
        ...
        <P className="mb-5">
          Куда ушли деньги? Точно не футболистам — каждый игрок сборной Испании получит около <strong className="text-[var(--color-text)]">€755 тыс.</strong> до налогов<Cite n={4} />. И точно не обычным болельщикам: <strong className="text-[var(--color-text)]">66,7%</strong> кошельков на Polymarket закрылись в минусе, по данным аналитика defioasis<Cite n={5} />. Деньги ушли узкой группе: крупным трейдерам, арбитражёрам, самим биржам, рекламе, мошенникам и спонсорам. Мы составили их список.
        </P>
      </section>
      ...
      <section className="mb-12">
        ...
        <P className="mb-5">
          В дни перед финалом Polymarket считал вероятность победы Испании примерно <strong className="text-[var(--color-text)]">58–59%</strong>, Аргентины — <strong className="text-[var(--color-text)]">41–42%</strong><Cite n={28} />. Kalshi, по данным Fortune, показывал аналогичные, но не идентичные цифры. В моменты высокой волатильности — например, после новостей о составах или после первого тайма — расхождения достигали 3–5 процентных пунктов.
        </P>
        <P className="mb-5">
          Примерный расчёт: если бы арбитражёр нашёл расхождение в 4 процентных пункта и вложил $1 млн, теоретически он заработал бы $40 тыс. минус комиссии. Но USDC между биржами идёт не мгновенно, цены могут поменяться, а крупная ставка сама двигает рынок. Реальная прибыль ниже, но не ноль.
        </P>
        <Note>
      ...
      <section className="mb-12">
        ...
        <ul className="mb-5 list-disc space-y-2 pl-5 text-[15px] leading-[1.8] text-[var(--color-dim)] marker:text-[var(--color-border)]">
          ...
          <li><strong className="text-[var(--color-text)]">Арбитражёры.</strong> Люди, которые заработали на разнице цен между Kalshi и Polymarket.</li>
