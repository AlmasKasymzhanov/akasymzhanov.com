...
function S4() {
  ...
  return (
    ...
    >
      <H size={58}>
        Freedom обзванивает продавцов Kaspi - и обещает разрешить всё, что тот запрещал.
      </H>
      ...
      <div className="mt-12">
        <Takeaway>Freedom продаёт селлерам не комиссию. Он продаёт всё, что им запрещал Kaspi.</Takeaway>
      </div>
    </Slide>
  );
}
